...
angular.module("cummins-supervisorio").controller("cycleTimeWorkStationReportCtrl", function ($scope, $http, $sce, reportUtilsService, portsAPI) {
  ...
  $scope.generateReport = function () {
	...
	//Validação estranha $('#report-cycletime-station-InitialDate').datepicker('getFormattedDate');
    $scope.modelObj.FinalDate = $scope.finalDateI;
	//Validação estranha $('#report-cycletime-station-FinalDate').datepicker('getFormattedDate');
    ...
    for(var i=0; i<$scope.WorkStationsList.length; i++){
       if($scope.WorkStationsList[i].value === $scope.modelObj.WS){
           $scope.modelObj.WSDesc = $scope.WorkStationsList[i].title;
           break;
       }
    }
  ...
  $scope.loadShopOrdersAndFamilies = function () {
	...
	//$('#report-cycletime-station-InitialDate').datepicker('getFormattedDate');
    var finalDate = $scope.finalDateI;
	//$('#report-cycletime-station-FinalDate').datepicker('getFormattedDate');
